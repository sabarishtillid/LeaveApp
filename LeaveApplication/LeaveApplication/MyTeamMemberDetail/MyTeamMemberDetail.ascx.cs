...
namespace LeaveApplication.MyTeamMemberDetail
{
    ...
    public partial class MyTeamMemberDetail : WebPart
    {
        ...
        internal SPListItemCollection GetListItemCollection(SPList spList, string key, string value, string keyone)
        {
                ...
                Query =
                    @"<Where>
                        <And>
                            ...
                            <Eq>
                               <OrderBy> <FieldRef Name='" + spFieldone.InternalName +
                                    @"'/><Value Type='" + spFieldone.Type.ToString() + @"'>Active</Value></OrderBy>
                            </Eq>
                        </And>
                      </Where>"
            };
        ...
        internal DataTable GetEmployeeLeaves()
        {
            ...
            try
            {
                ...
                if (IsMemberInGroup("Admin"))
                {
                    ...
                    employeeList = GetListItemCollection(SPContext.Current.Web.Lists.TryGetList(Utilities.EmployeeScreen), "Status", "Active");
                        //SPContext.Current.Web.Lists.TryGetList(Utilities.EmployeeScreen).GetItems();
                ...
                else
                {
                    employeeList =
                        GetListItemCollection(SPContext.Current.Web.Lists.TryGetList(Utilities.EmployeeScreen),
                                              Utilities.Manager, currentUser, "Status");
                }
